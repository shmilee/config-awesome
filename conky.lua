...
the_Date = {
    {y = 2019, m =  1, d =  1, name = '元旦'},
    {y = 2019, m =  1, d = 16, name = '(冬)考试周'},
    {y = 2019, m =  1, d = 26, name = '寒假'},
    {y = 2019, m =  2, d = 22, name = '(春)开学'},
    {y = 2019, m =  4, d =  5, name = '清明'},
    {y = 2019, m =  4, d = 22, name = '(春)考试周'},
    {y = 2019, m =  5, d =  1, name = '劳动节'},
    {y = 2019, m =  5, d = 18, name = '(春)校运会'},
    {y = 2019, m =  5, d = 21, name = '校庆'},
    {y = 2019, m =  6, d =  7, name = '端午'},
    {y = 2019, m =  6, d = 25, name = '(夏)考试周'},
    {y = 2019, m =  7, d =  5, name = '暑假'},
    {y = 2018, m =  9, d = 14, name = '(秋)开学'},
    {y = 2018, m =  9, d = 24, name = '中秋'},
    {y = 2018, m = 10, d =  1, name = '国庆'},
    {y = 2018, m = 10, d = 26, name = '(秋)校运会'},
    {y = 2018, m = 11, d = 14, name = '(秋)考试周'},
    {y = 2018, m = 12, d = 31, name = '学生节'}
}
