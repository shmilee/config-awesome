...
the_Date = {
    {y = 2018, m =  1, d =  1, name = '元旦'},
    {y = 2018, m =  1, d = 18, name = '(冬)考试周'},
    {y = 2018, m =  1, d = 28, name = '寒假'},
    {y = 2018, m =  3, d =  3, name = '(春)开学'},
    {y = 2018, m =  4, d =  5, name = '清明'},
    {y = 2018, m =  5, d =  2, name = '(春)考试周'},
    {y = 2018, m =  5, d =  1, name = '劳动节'},
    {y = 2018, m =  5, d = 19, name = '(春)校运会'},
    {y = 2018, m =  5, d = 21, name = '校庆'},
    {y = 2018, m =  6, d = 18, name = '端午'},
    {y = 2018, m =  7, d =  2, name = '(夏)考试周'},
    {y = 2018, m =  7, d = 12, name = '暑假'},
    {y = 2017, m =  9, d = 15, name = '(秋)开学'},
    {y = 2017, m = 10, d =  4, name = '中秋'},
    {y = 2017, m = 10, d =  1, name = '国庆'},
    {y = 2017, m = 10, d = 20, name = '(秋)校运会'},
    {y = 2017, m = 11, d = 16, name = '(秋)考试周'}
}
